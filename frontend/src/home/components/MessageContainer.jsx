  ...
  return (
    <div className="h-full flex flex-col md:min-w-[500px] bg-white">
      {selectedConversation === null ? (
        ...
        <>
          {/* Header */}
          <div className="flex justify-between items-center gap-1 bg-sky-600 md:px-4 h-12 border border-gray-400">
          ...
          {/* Message List */}
{/* <div className="flex-1 overflow-y-auto px-3 py-2 space-y-1 scrollbar-thin scrollbar-thumb-sky-400 scrollbar-track-gray-200"> */}

            <div className="flex-1 overflow-y-scroll px-3 py-2 space-y-1 scrollbar-thin scrollbar-thumb-sky-400 scrollbar-track-gray-200">
